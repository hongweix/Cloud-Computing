...
public class Main {
	...
	static {
		//put the original 3 data center in the instances[] array
    ...
    // originally this method only throws IOException, but in fact it can throw other exception, so change it to normal Exception
