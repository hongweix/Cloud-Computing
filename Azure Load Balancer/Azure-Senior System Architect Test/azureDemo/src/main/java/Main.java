...
public class Main {
	...
	static {
		// put the original three data centers in the instances[] array
    ...
    // originally this method only throws IOException, but in fact, it can throw other exception, so i change it to normal Exception
