...
/**
 * Almost the same AzureVMApi demo code used to create vm, I just change some parameter and method name
 */
public class AzureVMApi {
    ...
    /**
     * Originally this method is called main() method, I just change the name of it to clearly differentiate
     * from Main.java
     */
    public static String Azuresupercreate() throws Exception {
      // instantiate a AzureVMApi object
      ...
      //construct and return the new vm DNS
         return vmdcName+".eastus.cloudapp.azure.com";
    }
    
   /**
    * check rps method almost the same with project2.1
    */
    ...
    /**
     * fetch information on web page method almost same with project2.1
     */
