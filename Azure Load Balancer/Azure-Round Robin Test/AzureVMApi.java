...
/**
 * This class is the same of Project2.1 which is used to create vm, I just change a little in parameter and method name
 */
public class AzureVMApi {
    ...
    /**
     * Other class may use this method to create a new vm, this method has the same
     * function as the original AzureVMApiDemo's main method
     *
     */
    public static String Azuresupercreate() throws Exception {
        //instantiate the AzureVMApi object
        AzureVMApi vm = new AzureVMApi();
        //generate new data center name and resource group name
        ...
        System.out.println(checkVM(context, vmdcName));
         //construct and return the DNS of this new vm
         return vmdcName+".eastus.cloudapp.azure.com";
    }
    
    /**
     * Same function as in Project2.1 to check the rps of the vm, but in this Project it is not used,
    ...
    /**
     * Same function as in Project2.1 to fetch the page content of the vm, but in this Project it is not used,
     * I just keep it there
     */
